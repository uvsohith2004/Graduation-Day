...
const homeData = {
  ...
  eventAddress: "KVR Convention, Jammalapalem, Kavali, SPSR Nellore District",
  ...
  // Images
  heroImages: {
    main: "https://static.vecteezy.com/system/resources/thumbnails/028/246/511/small/graduation-caps-thrown-in-the-air-generative-ai-photo.jpg",
    graduationScroll:
